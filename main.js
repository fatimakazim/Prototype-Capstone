...
subtitle: 'Now I don’t know what condition it’s in, but the stairs of this temple once had slabs donated by Sikh and Hindu families, with their names written on them — and those names are still there today. This whole area used to be a Hindu settlement, where Muslim, Sikh, and Hindu communities all lived together.',   speakerLabel:       'Local Man 2',
 ...
 },
 {
   ...
   audio:              '#audio-stop-6',
subtitle: 'At the edge of the village the fields begin. In 1947 many families walked out through here, believing they would return within weeks. Muslim, Hindu, Sikh families lived side by side in these lanes. They did not call themselves by religion — they called each other by name.',   speakerLabel:       'Local Man 1',
 ...
 },
 {
   ...
   audio:              '#audio-stop-7',
subtitle: 'Before, these streets were all unpaved, with small homes and open courtyards. Slowly, everything began to change — roads were built, houses became larger, and new buildings appeared. Saidpur is no longer the same village it once used to be.',   speakerLabel:       'Memory',
 ...
 },
 {
   ...
   audio:              '#audio-stop-8',
subtitle: 'You see that big banyan tree over there? Beneath it, there used to be a water-powered mill called a “Jandar,” where local people would come to grind flour before taking it back home to use in their daily lives.',   speakerLabel:       'Local Man 2',
 ...
 },
 {
   ...
   audio:              '#audio-stop-9',
   subtitle: 'After Partition, this place changed a lot. Many people left, new families arrived, and slowly the sense of community began to fade. Most of the younger generation has moved away now — only older people like us still remain in the village. The village is still here, but it no longer feels the way it once did.',
