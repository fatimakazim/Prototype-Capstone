...
(function () {
   ...
   const TOUR_STOPS = [
 {
   ...
   target:             '#focus-shops',
   audio:              '#audio-stop-1',
subtitle: "Welcome to Saidpur. Before partition, this village was home to Hindu, Sikh and Muslim communities who lived side by side. The markets were full of life, and people knew each other not by religion, but by name. And now, I will guide you through Saidpur using snippets from conversations with local residents. People who have lived here, grown up here, and carried its memories with them. Through their voices and stories, you'll hear how they describe the village, its history and the ways it has changed over time.",
speakerLabel: "Globe Narrator:",   highlightColor:     '#ddccff',
 ...
 },
 {
   ...
   speakerLabel:       'Stop 1 : Margalla Hills',
 ...
 },
 {
   ...
   speakerLabel:       'Stop 2 : Handicraft Area',
 ...
 },
 {
   ...
   speakerLabel:       'Stop 3 : Central Mosque',
 ...
 },
 {
   ...
   target:             '#focus-temple',
   audio:              '#audio-stop-5',
subtitle: 'Now I don’t know what condition it’s in, but the stairs of this temple once had slabs donated by Sikh and Hindu families, with their names written on them — and those names are still there today. This whole area used to be a Hindu settlement, where Muslim, Sikh, and Hindu communities all lived together.',   
   speakerLabel:       'Stop 4 : Temple/Mandir',
highlightColor:     '#9ee8ff',
 ...
 },
 {
   ...
   audio:              '#audio-stop-6',
subtitle: 'At the edge of the village the fields begin. In 1947 many families walked out through here, believing they would return within weeks. Muslim, Hindu, Sikh families lived side by side in these lanes. They did not call themselves by religion — they called each other by name.',   speakerLabel:       'Stop 5: Village Edge',
 ...
 },
 {
   ...
   audio:              '#audio-stop-7',
subtitle: 'Before, these streets were all unpaved, with small homes and open courtyards. Slowly, everything began to change — roads were built, houses became larger, and new buildings appeared. Saidpur is no longer the same village it once used to be.',   speakerLabel:       'Stop 6: East Neighbourhood',
 ...
 },
 {
   ...
   audio:              '#audio-stop-8',
subtitle: 'You see that big banyan tree over there? Beneath it, there used to be a water-powered mill called a “Jandar,” where local people would come to grind flour before taking it back home to use in their daily lives.',   speakerLabel:       'Stop 7: Field',
 ...
 },
 {
   ...
   audio:              '#audio-stop-9',
   subtitle: 'After Partition, this place changed a lot. Many people left, new families arrived, and slowly the sense of community began to fade. Most of the younger generation has moved away now — only older people like us still remain in the village. The village is still here, but it no longer feels the way it once did.',speakerLabel:       'Stop 8: Old Streets',
