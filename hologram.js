...
// /* ════════════════════════════════════════════════════════════════════
//    Intro hologram background audio (index.html + standalone holo page)
//    Loaded before main.js — used by introSceneController in main.js.
// ════════════════════════════════════════════════════════════════════ */
// (function introHoloAudioApi () {
//   'use strict';

//   const DEFAULT_SEL = '#holo-audio';

//   function getAudio (selector) {
//     return document.querySelector(selector || DEFAULT_SEL);
//   }

//   function stop (selector) {
//     const a = getAudio(selector);
//     if (!a) return;
//     a.pause();
...
//   function start (opts) {
//     const o = opts || {};
//     const a = getAudio(o.selector);
//     if (!a) return Promise.resolve(false);
//     if (typeof o.volume === 'number') a.volume = o.volume;
//     a.loop = o.loop !== false;
//     return a.play().then(() => true).catch(() => false);
//   }

//   function bindGestureUnlock (opts) {
//     const o = opts || {};
//     const onUnlock = () => {
...
//   window.IntroHoloAudio = { getElement: getAudio, start, stop, bindGestureUnlock };
// })();